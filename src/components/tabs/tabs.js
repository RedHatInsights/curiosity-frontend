 ...
 * review using a window.setTimeout(() => handleScrollButtons()) in componentDidMount. We
 * coincidentally had to apply a similar technique to our minHeight component.
 *
 ...
 */
/**
 * ToDo: Reevaluate using array vs children format
 * In an effort to be consistent with the PF Table component, require props on another Tab wrapper,
 * and avoid having to deal with re-purposing the children prop we opted to use an array.
 */
/**
