 ...
 *     RHSM_API_RESPONSE_META_TYPES: string, RHSM_API_QUERY_GRANULARITY_TYPES: {WEEKLY: string, QUARTERLY: string,
 ...
 *     OFFSET: string, SLA: string, LIMIT: string}, RHSM_API_QUERY_SORT_TYPES: {CORES: string, DATE: string,
 *     HARDWARE: string, SOCKETS: string, MEASUREMENT: string, NAME: string},
