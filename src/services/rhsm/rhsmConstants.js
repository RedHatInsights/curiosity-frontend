 ...
 *     RHSM_API_RESPONSE_BILLING_ACCOUNT_ID_TYPES: {ORG_ID: string, PRODUCT_TAG: string, BILLING_ACCOUNT_ID: string,
 *     BILLING_PROVIDER: string}, RHSM_API_RESPONSE_INSTANCES_DATA_TYPES: {MEASUREMENTS: string, BILLING_ACCOUNT_ID:
 *     string, CATEGORY: string, SUBSCRIPTION_MANAGER_ID: string, INVENTORY_ID: string, NUMBER_OF_GUESTS: string,
 *     BILLING_PROVIDER: string, DISPLAY_NAME: string, CLOUD_PROVIDER: string, INSTANCE_ID: string, LAST_SEEN: string},
 ...
 *     START_DATE: string, DISPLAY_NAME: string, USAGE: string, CATEGORY: string, SORT: string, OFFSET: string,
 *     BILLING_PROVIDER: string}, RHSM_API_RESPONSE_ERRORS: string, RHSM_API_RESPONSE_META: string,
 *     RHSM_API_RESPONSE_GRANULARITY_TYPES: {WEEKLY: string, QUARTERLY: string, DAILY: string, MONTHLY: string},
 *     RHSM_API_QUERY_SET_TYPES: {ORG_ID: string, GRANULARITY: string, BILLING_ACCOUNT_ID: string, DIRECTION: string,
 *     END_DATE: string, METRIC_ID: string, SLA: string, LIMIT: string, START_DATE: string, DISPLAY_NAME: string,
 *     USE_RUNNING_TOTALS_FORMAT: string, BILLING_CATEGORY: string, PRODUCT_TAG: string, USAGE: string, CATEGORY:
 *     string, SORT: string, OFFSET: string, BILLING_PROVIDER: string},
