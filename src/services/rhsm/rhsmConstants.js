 ...
 * @type {string}
 */
const RHSM_API_RESPONSE_ID = 'ids';
 ...
 *
 * @type {{ORG_ID: string, PRODUCT_TAG: string, BILLING_ACCOUNT_ID: string, BILLING_PROVIDER: string}}
 */
const RHSM_API_RESPONSE_BILLING_ACCOUNT_ID_TYPES = {
 ...
 *
 * @type {{ORG_ID: string, PRODUCT_TAG: string}}
 */
const RHSM_API_QUERY_SET_BILLING_ACCOUNT_ID_TYPES = {
  PRODUCT_TAG: 'product_tag',
  ORG_ID: 'org_id'
};
 ...
 *
 * @type {{ORG_ID: string, GRANULARITY: string, BILLING_ACCOUNT_ID: string, DIRECTION: string, END_DATE: string,
 *     METRIC_ID: string, SLA: string, LIMIT: string, START_DATE: string, DISPLAY_NAME: string,
 *     USE_RUNNING_TOTALS_FORMAT: string, BILLING_CATEGORY: string, PRODUCT_TAG: string, USAGE: string, CATEGORY:
 *     string, SORT: string, OFFSET: string, BILLING_PROVIDER:
 *     string}}
 */
const RHSM_API_QUERY_SET_TYPES = {
  ...RHSM_API_QUERY_SET_BILLING_ACCOUNT_ID_TYPES,
 ...
 * RHSM constants.
 *
 * @type {{RHSM_API_QUERY_SET_TALLY_CAPACITY_TYPES: {GRANULARITY: string, BILLING_ACCOUNT_ID: string, USAGE: string,
 *     CATEGORY: string, END_DATE: string, SLA: string, START_DATE: string, BILLING_PROVIDER: string,
 *     USE_RUNNING_TOTALS_FORMAT: string, BILLING_CATEGORY: string}, RHSM_API_RESPONSE_DATA: string,
 *     RHSM_API_RESPONSE_SUBSCRIPTIONS_META_TYPES: {MEASUREMENTS: string, PRODUCT: string, SUBSCRIPTION_TYPE: string,
 *     COUNT: string}, RHSM_API_PATH_PRODUCT_VARIANT_SATELLITE_TYPES: {SATELLITE_SERVER: string, SATELLITE_CAPSULE:
 *     string}, RHSM_API_PATH_METRIC_TYPES: {CORES: string, STORAGE_GIBIBYTES: string, INSTANCE_HOURS: string, SOCKETS:
 *     string, MANAGED_NODES: string, TRANSFER_GIBIBYTES: string, VCPUS: string, CORE_SECONDS: string,
 *     STORAGE_GIBIBYTE_MONTHS: string}, RHSM_API_RESPONSE_INSTANCES_META_TYPES: {MEASUREMENTS: string, PRODUCT:
 *     string, COUNT: string}, RHSM_API_RESPONSE_BILLING_ACCOUNT_ID_TYPES: {ORG_ID: string, PRODUCT_TAG: string,
 *     BILLING_ACCOUNT_ID: string, BILLING_PROVIDER: string}, RHSM_API_RESPONSE_INSTANCES_DATA_TYPES: {MEASUREMENTS:
 ...
 *     string, DIRECTION: string, END_DATE: string, METRIC_ID: string, SLA: string, LIMIT: string, START_DATE: string,
 *     DISPLAY_NAME: string, USE_RUNNING_TOTALS_FORMAT: string, BILLING_CATEGORY: string, PRODUCT_TAG: string, USAGE:
 *     string, CATEGORY: string, SORT: string, OFFSET: string, BILLING_PROVIDER: string},
