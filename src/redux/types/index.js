 ...
 *     GET_PLATFORM_EXPORT_STATUS: string, PLATFORM_ADD_NOTIFICATION: string, PLATFORM_REMOVE_NOTIFICATION: string,
...
const platformTypes = {
  ...
  GET_PLATFORM_EXPORT_STATUS: 'GET_PLATFORM_EXPORT_STATUS',
