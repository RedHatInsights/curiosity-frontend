 ...
 *     SET_PRODUCT_VARIANT_QUERY_RESET_ALL: string, UPDATE_USER_OPTIN: string, STATUS_5XX: string, DELETE_USER_OPTIN:
 *     string}}
 */
const appTypes = {
  STATUS_4XX: '4XX',
 ...
 *
 * @type {{PLATFORM_USER_AUTH: string, DELETE_PLATFORM_EXPORT_EXISTING: string, GET_PLATFORM_EXPORT_EXISTING: string,
 *     SET_PLATFORM_EXPORT_EXISTING_STATUS: string, SET_PLATFORM_EXPORT_CREATE: string, SET_PLATFORM_EXPORT_RESET:
 *     string, SET_PLATFORM_EXPORT_STATUS: string}}
 */
const platformTypes = {
  ...
  SET_PLATFORM_EXPORT_RESET: 'SET_PLATFORM_EXPORT_RESET',
 ...
 *
 * @type {{SET_QUERY_BILLING_ACCOUNTS: string, SET_QUERY_INVENTORY_GUESTS: string, SET_QUERY_INVENTORY_INSTANCES:
 *     string, SET_QUERY_GRAPH: string, SET_QUERY_CLEAR: string, SET_QUERY_CLEAR_INVENTORY_LIST: string,
 *     SET_QUERY_INVENTORY_SUBSCRIPTIONS: string, SET_QUERY: string, SET_QUERY_RESET_INVENTORY_LIST: string,
 *     SET_QUERY_CLEAR_INVENTORY_GUESTS_LIST: string}}
 */
const queryTypes = {
  SET_QUERY: 'SET_QUERY',
  SET_QUERY_BILLING_ACCOUNTS: 'SET_QUERY_BILLING_ACCOUNTS',
 ...
 *
 * @type {{SET_CONFIG_RHSM_RESET: string, GET_GRAPH_CAPACITY_RHSM: string,
 *     GET_INSTANCES_INVENTORY_GUESTS_RHSM: string, GET_SUBSCRIPTIONS_INVENTORY_RHSM: string,
 *     GET_INSTANCES_INVENTORY_RHSM: string, GET_BILLING_ACCOUNTS_RHSM: string, GET_GRAPH_TALLY_RHSM:
 *     string}}
 */
const rhsmTypes = {
  GET_BILLING_ACCOUNTS_RHSM: 'GET_BILLING_ACCOUNTS_RHSM',
  ...
  SET_CONFIG_RHSM_RESET: 'SET_CONFIG_RHSM_RESET'
};
