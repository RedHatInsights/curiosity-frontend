...
1. Confirm within `package.json` that the NPM scripts
   ...
   - `$ start:proxy` has a browser open command aimed at `...proxy; open https://ci.foo.redhat.com:443...` 
1. Run the build again, `$ yarn start:proxy`
1. Confirm you browser is pointed at `https://ci.foo.redhat.com:443...`
...
1. Open a couple of instances of Terminal and run...
    ...
    $ yarn test:dev
    ```
1. Make sure your browser opened around the domain `https://*.foo.redhat.com:443`
1. Start developing...
